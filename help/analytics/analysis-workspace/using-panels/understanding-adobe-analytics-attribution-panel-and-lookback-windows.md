...
Selon [[!DNL Adobe]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/attribution/overview.html?lang=fr), *attribution* permet aux analystes de personnaliser la manière dont les éléments *Dimension* sont crédités pour les *événements de succès*.
