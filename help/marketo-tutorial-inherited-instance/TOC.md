---
user-guide-title: Tutoriel - Conseils et astuces pour le contrôle d’une instance héritée
user-guide-description: 'Conseils et astuces pour auditer une instance héritée [!DNL Marketo Engage] '
breadcrumb-title: 'Tutoriel - Conseils et astuces pour le contrôle d’une instance héritée [!DNL Marketo Engage] '
...
# Tutoriel - Conseils et astuces pour auditer une instance [!DNL Marketo Engage] héritée {#auditing-an-inherited-instance}
...
+ [Consigner les erreurs de synchronisation CRM pour le dépannage](/help/marketo-tutorial-inherited-instance/log-crm-sync-errors-for-easy-troubleshooting.md)
