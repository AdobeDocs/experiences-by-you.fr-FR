...
|--- |--- |--- |--- |
| Examen des opérations marketing | <ul><li>Mises à jour et responsabilités de l’équipe des opérations marketing</li><li>Présentation de la pile et des processus de technologie marketing</li><li>Création de campagne (de bout en bout)</li><li>Examiner les processus actuels pour identifier et combler les lacunes</li></ul> | Après examen de personne, passez la main du Marketo Engage, sondez les processus actuels et les souhaits | 2,5 h |
| Présentation Marketo Engage | <ul><li>Présentation détaillée de haut niveau du Marketo Engage</li><li>Types de campagne et conventions de dénomination</li><li>Marketo Engage + intégration CRM | Démo en direct, session de travail de convention de dénomination, session d’invité avec opérations de vente, | 1,5 h |
| Emails + landing pages | <ul><li>Présentation des modèles d&#39;email et de landing page</li><li>Exemples de landing pages actives</li><li>Définition des critères d&#39;audience et des URL cibles des boîtes de dialogue</li><li>Bonnes pratiques de création d&#39;email + landing page</li></ul> | Liens de travail en direct, exemples interactifs, examen des bonnes pratiques du secteur | 1h |
| Gestion des événements + intégration de webinaire | Pages d’enregistrement + application d’archivage iPad | Démonstration en direct du processus d’inscription à un webinaire et de l’archivage d’iPad | 1h |
|  | Webinaire interactif | Démonstration en direct de la création, de la gestion et de la diffusion d’événements dans Marketo Engage | 1h |
| Automatisation des conversations + Intégration de solutions Chatbot | <ul><li>Activation de la messagerie instantanée en tant que nouveau canal marketing</li><li>Dynamic Chat : installation du fragment de code chatbot, création et publication de boîtes de dialogue automatisées</li></ul> | Vidéo enregistrée de création de boîtes de dialogue et de développement de critères d&#39;audience, revue du concepteur de diffusion | 1h |
| Marketo Sales Insight | <ul><li>Envoi et suivi d’emails à partir de Marketo Sales Insight</li><li>Module externe MSI Outlook</li></ul> | Vidéo enregistrée du processus de bout en bout pour une distribution facile aux nouveaux employés | 1h |
